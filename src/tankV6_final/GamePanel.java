    ...
    public GamePanel() {
        ...
        if (!isLoadGame()) {
            ...
            for (Node n: getNodes()) {
                ...
                switch (type) {
                    case 0:
                        EnemyTank et = new EnemyTank(n.getX(), n.getY(), 1, n.getSpeed());
                        et.setDirection(n.getDirection());
                        ets.add(et);
                        et.setEts(ets);
                        et.fire();
                        ...
                        break;
                    case 1:
                        hero = new Hero(n.getX(), n.getY(), 0, n.getSpeed());
                        break;
//                    case 2:
//                        Bullet b = new Bullet(n.getX(), n.getY(), n.getDirection(), n.getSpeed());
//                        break;
                    case 4:
                        Material m = new Brick(n.getX(), n.getY());
                        mat.add(m);
                        break;
                    case 5:
                        GameRecorder.setMyLife(n.getY());
                        GameRecorder.setNumDeadNPC(n.getDirection());
                        GameRecorder.setTotalNPC(n.getX());
                }
            }
            initializeMap2();
            setLoadGame(false);
    ...
    private void initializeNPC() {
        ...
        for (int i = 0; i < GameRecorder.getTotalNPC(); i++) {
            if (i < 3) {
                et = new EnemyTank((i + 1) * 90, 70, 1, 1);
            } else {
                et = new EnemyTank(400 + i * 90, 70, 1, 1);
            }
            ets.add(et);
            et.setEts(ets);
            et.fire();
